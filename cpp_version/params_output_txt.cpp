...
output_params_txt::output_params_txt( ostream& o_str, const bool&output_non_nop ):
  o_str( o_str ), output_non_nop(output_non_nop)
{
										  ...
										  const signals_param_action&action)
{
  ...
  if ( output_non_nop || action.action == signals_param_action::nop )
	{
	  ...
	  switch( action.action )
		...
		case signals_param_action::nop:
		  out_line << "No operation, additional information: " << dec << action.value << endl;
		  break;
		default:
		  out_line << endl;
		  break;
...
output_params_txt_file::output_params_txt_file( ofstream& o, const bool&output_non_nop ):
  of_str( move( o )),output_params_txt( of_str, output_non_nop )
{}
